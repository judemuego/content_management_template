...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['prefix' => '/inventory'], function (){
        ...
        Route::group(['prefix' => '/product'], function (){
            Route::get          ('/',                            'ProductController@index'                              )->name('bag');
            Route::get          ('/get',                         'ProductController@get'                                )->name('get_bag');
            Route::post         ('/save',                        'ProductController@store'                              )->name('save_bag');
            Route::get          ('/edit/{id}',                   'ProductController@edit'                               )->name('edit_bag');
            Route::post         ('/update/{id}',                 'ProductController@update'                             )->name('update_bag');
            Route::get          ('/destroy/{id}',                'ProductController@destroy'                            )->name('destroy_bag');
        });
